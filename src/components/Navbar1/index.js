    ...
    return (
        ...
        >
            <div className="text-slate-900 font-medium flex flex-col md:flex-row items-center px-10 md:px-15 lg:px-24 xl:px-32">
                ...
                <div
                    id="collapse-navbar"
                    className="fixed h-0 md:h-auto mt-16 md:mt-0 md:ms-10 md:pt-0 md:pb-0 md:grow md:relative w-full md:w-auto bg-gradient-to-r md:bg-transparent from-orange-200 md:from-transparent to-amber-200 md:to-transparent overflow-auto transition-all duration-200 ease-linear"
                >
